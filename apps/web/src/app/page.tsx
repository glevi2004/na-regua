    ...
    <>
      ...
      <main>
        ...
        <FeatureSection
          ...
          title={
            <>
              Do balcao ao caixa em{" "}
              <span className="gradientText">segundos</span>
            </>
          }
        ...
        <FeatureSection
          ...
          title={
            <>
              O caixa do mes que vem,{" "}
              <span className="gradientText">hoje</span>
            </>
          }
        ...
        <FeatureSection
          ...
          title={
            <>
              Pergunte. O sistema{" "}
              <span className="gradientText">responde</span>.
            </>
          }
