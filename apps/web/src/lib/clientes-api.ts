...
export type CpfResult =
  | { ok: true; nome: string }
  | { ok: false; error: string; indisponivel?: boolean };
...
export function comprasDoCliente(clienteId: string): CompraCliente[] {
  const base: Record<string, CompraCliente[]> = {
    "cli-1": [
      { id: "v1", numero: "1842", data: "2026-08-24", valor: 86.9, itens: 6, formaPagamento: "Pix" },
      { id: "v2", numero: "1798", data: "2026-08-11", valor: 214.4, itens: 12, formaPagamento: "Credito" },
      { id: "v3", numero: "1755", data: "2026-07-29", valor: 132.0, itens: 8, formaPagamento: "Dinheiro" },
    ],
    "cli-2": [
      { id: "v4", numero: "1839", data: "2026-08-23", valor: 156.2, itens: 4, formaPagamento: "Debito" },
      { id: "v5", numero: "1801", data: "2026-08-12", valor: 4820.0, itens: 96, formaPagamento: "Credito" },
    ],
    "cli-3": [
      { id: "v6", numero: "1840", data: "2026-08-24", valor: 412.5, itens: 18, formaPagamento: "Dinheiro" },
    ],
    "cli-4": [
      { id: "v7", numero: "1702", data: "2026-06-02", valor: 2310.5, itens: 44, formaPagamento: "Credito" },
    ],
  };
...
export function pendenciasDoCliente(clienteId: string): PendenciaCliente[] {
  const base: Record<string, PendenciaCliente[]> = {
    "cli-2": [
      { id: "p1", referente: "Pedido 8891", vencimento: "2026-08-25", valor: 4820.0, status: "aberto" },
      { id: "p2", referente: "Pedido 8880", vencimento: "2026-09-05", valor: 3740.0, status: "parcial" },
    ],
    "cli-4": [
      { id: "p3", referente: "Pedido 8874", vencimento: "2026-08-16", valor: 2310.5, status: "vencido" },
    ],
    "cli-3": [
      { id: "p4", referente: "Venda 1840", vencimento: "2026-09-19", valor: 412.5, status: "aberto" },
    ],
  };
  return base[clienteId] ?? [];
}
...
export function contatosDoCliente(clienteId: string): ContatoCliente[] {
  const base: Record<string, ContatoCliente[]> = {
    "cli-2": [
      ...
      { id: "c2", data: "2026-08-14", tipo: "ligacao", descricao: "Confirmou pedido 8891 para o dia 25." },
    ],
    "cli-4": [
      { id: "c3", data: "2026-08-18", tipo: "ligacao", descricao: "Cobranca do pedido 8874. Prometeu pagar dia 22." },
      { id: "c4", data: "2026-06-02", tipo: "visita", descricao: "Visita ao restaurante, apresentada linha de azeites." },
    ],
    "cli-5": [
      { id: "c5", data: "2026-03-11", tipo: "observacao", descricao: "Compra pontual, sem recorrencia ate agora." },
    ],
  };
  return base[clienteId] ?? [];
}
