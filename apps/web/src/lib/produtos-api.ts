...
export async function buscarNcm(termo: string): Promise<SugestaoNcm[]> {
  ...
  return tabela.filter(
    (n) => n.descricao.toLowerCase().includes(t) || n.codigo.startsWith(t),
  );
}
...
export function movimentacoesEstoque(produtoId: string): MovimentoEstoque[] {
  const base: Record<string, MovimentoEstoque[]> = {
    "prod-1": [
      { id: "m1", data: "2026-08-24", tipo: "saida", quantidade: 2, saldo: 4, origem: "Venda 1842" },
      { id: "m2", data: "2026-08-22", tipo: "saida", quantidade: 6, saldo: 6, origem: "Venda 1830" },
      { id: "m3", data: "2026-08-18", tipo: "ajuste", quantidade: -2, saldo: 12, origem: "Ajuste manual", motivo: "Avaria no transporte" },
      { id: "m4", data: "2026-08-10", tipo: "entrada", quantidade: 24, saldo: 14, origem: "NF-e 4471 · Torrefacao Aurora" },
    ],
    "prod-2": [
      { id: "m5", data: "2026-08-23", tipo: "saida", quantidade: 3, saldo: 2, origem: "Venda 1842" },
      { id: "m6", data: "2026-08-05", tipo: "entrada", quantidade: 12, saldo: 5, origem: "NF-e 4465 · Engenho Doce" },
    ],
    "prod-3": [
      { id: "m7", data: "2026-08-24", tipo: "saida", quantidade: 12, saldo: 6, origem: "Venda 1840" },
      { id: "m8", data: "2026-08-15", tipo: "entrada", quantidade: 36, saldo: 18, origem: "NF-e 4468 · Campo Verde" },
    ],
  };
 ...
 */
export function lerXmlNfe(texto: string): { ok: true; nota: NotaXml } | { ok: false; error: string } {
  let doc: Document;
  try {
