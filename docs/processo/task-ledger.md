...
| ⬜ A fazer, pode começar hoje |      25 |   71 |
...
cadastros no schema (NR-008). Dos 114 dias que faltam, **71 podem começar
hoje**, em 25 tarefas; 43 seguem bloqueados por 11 decisões. A próxima da fila
é a NR-020, o schema de vendas e financeiro.
...
**O nó agora é a NR-020**, o schema de vendas e financeiro: ele abre
`registerSale` (NR-022) e, atrás dele, a rota de venda e o PDV.
...
**43 dos 114 dias-desenvolvedor restantes estão bloqueados por 11 decisões** —
38% do que falta. Decidir continua rendendo, mas deixou de ser a única coisa que
...
| ------------------------------- | ------: | ---: | ------------------------------------------------ |
| 🔵 1 — Núcleo & Dados           |      18 |   45 | é o gargalo; a fila dela segue em NR-020         |
