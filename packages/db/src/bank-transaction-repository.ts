...
/**
 * `toISOString().slice(0,10)` seria errado aqui: o `Date` de uma coluna `date`
 * vem a meia-noite local, e converter para UTC pode RECUAR um dia. Num extrato
 * isso moveria a transacao para o dia anterior — e a data e metade do criterio
 * de conciliacao.
 */
